...
public class SalesDomainControllerImpl implements SalesDomainController {
	 ...
	 * 
	 * (non-Javadoc)
	 * @see ee.ut.math.tvt.salessystem.domain.controller.SalesDomainController#registerSale(ee.ut.math.tvt.salessystem.domain.data.Sale)
	 */
    ...
    public void refresh(String tabToRefresh){
    	
    	if(tabToRefresh.equals(SalesSystemUI.HISTORY)){
    		model.updateHistory(this);
    	} else if (tabToRefresh.equals(SalesSystemUI.WAREHOUSE)){
    		model.updateStock(this);
    	} else if (tabToRefresh.equals(SalesSystemUI.CLIENTS)){
    		model.updateClients(this);
    	}
    }
