...
public class SalesSystemModel {
	...
	public SalesSystemModel(SalesDomainController domainController) {
		...
		updateStock(domainController);
		updateClients(domainController);
		updateHistory(domainController);

	}

	public void updateStock(SalesDomainController domainController) {
		List<StockItem> stockItems = domainController.getAllStockItems();
		warehouseTableModel.populateWithData(stockItems);
	}

	public void updateHistory(SalesDomainController domainController) {
		List<Sale> sales = domainController.getAllSales();
		purchaseHistoryTableModel.populateWithData(sales);
	}

	public void updateClients(SalesDomainController domainController) {
